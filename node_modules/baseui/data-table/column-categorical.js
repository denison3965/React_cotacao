...
function FilterQuickControls(props) {
  return React.createElement(_index2.ButtonGroup, {
...
function HighlightCheckboxLabel(props) {
  ...
  if (!props.query) {
    return React.createElement(_index3.StyledLabel, restProps, children);
  }
...
function CategoricalFilter(props) {
  ...
  }, showQuery && React.createElement(_index4.Input, {
  ...
  }, !filteredCategories.length && React.createElement(_index6.Label3, null, "No Categories Found"), Boolean(filteredCategories.length) && filteredCategories.map(function (category, i) {
    return React.createElement("div", {
      className: checkboxStyles,
      key: i
    }, React.createElement(_index3.Checkbox, {
...
var CategoricalCell = React.forwardRef(function (props, ref) {
  ...
  }, props.textQuery ? React.createElement(_textSearch.HighlightCellText, {
    text: props.value,
