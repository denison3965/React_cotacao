...
function Tabs(_ref) {
  ...
  var uid = (0, _reactUid.useUID)(); // Unpack overrides
...
function InternalTab(_ref2) {
  ...
  return React.createElement(Tab, _extends({
    ...
    onFocus: (0, _focusVisible.forkFocus)(_objectSpread({}, restProps, {}, TabProps), handleFocus),
    onBlur: (0, _focusVisible.forkBlur)(_objectSpread({}, restProps, {}, TabProps), handleBlur)
...
function InternalTabPanel(_ref3) {
  ...
  return React.createElement(TabPanel, _extends({
    ...
    onFocus: (0, _focusVisible.forkFocus)(TabPanelProps, handleFocus),
    onBlur: (0, _focusVisible.forkBlur)(TabPanelProps, handleBlur)
