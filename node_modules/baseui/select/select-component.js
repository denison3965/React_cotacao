...
function (_React$Component) {
  ...
  _createClass(Select, [{
    ...
    value: function renderSearch() {
      ...
      var sharedProps = this.getSharedProps();
      return (// TODO(v11): remove searchIconProps from SearchIconContainer
    ...
    value: function render() {
      ...
      return React.createElement(_index.LocaleContext.Consumer, null, function (locale) {
        ...
        }, sharedProps, controlContainerProps), type === _constants.TYPE.search ? _this6.renderSearch() : null, React.createElement(ValueContainer, _extends({}, sharedProps, valueContainerProps), _this6.renderValue(valueArray, isOpen, locale), _this6.renderInput(), _this6.shouldShowPlaceholder() ? React.createElement(Placeholder, _extends({}, sharedProps, placeholderProps), typeof _this6.props.placeholder !== 'undefined' ? _this6.props.placeholder : locale.select.placeholder) : null), React.createElement(IconsContainer, _extends({}, sharedProps, iconsContainerProps), _this6.renderLoading(), _this6.renderClear(), type === _constants.TYPE.select ? _this6.renderArrow() : null))));
      });
    }
  }]);
