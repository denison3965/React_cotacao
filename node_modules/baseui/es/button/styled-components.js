...
export const BaseButton = styled('button', ({
  ...
  outline: $isFocusVisible && $shape !== SHAPE.round && $shape !== SHAPE.pill ? `3px solid ${$theme.colors.accent}` : 'none',
  outlineOffset: '-3px',
  boxShadow: $isFocusVisible && ($shape === SHAPE.round || $shape === SHAPE.pill) ? `0 0 0 3px ${$theme.colors.accent}` : 'none',
  textDecoration: 'none',
