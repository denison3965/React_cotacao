...
export function CategoricalFilter(props) {
  ...
  }, !filteredCategories.length && React.createElement(Label3, null, "No Categories Found"), Boolean(filteredCategories.length) && filteredCategories.map((category, i) => React.createElement("div", {
