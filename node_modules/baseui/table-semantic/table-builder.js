...
function (_React$Component) {
  ...
  _createClass(TableBuilder, [{
    ...
    value: function render() {
      ...
      var _getOverrides19 = (0, _overrides.getOverrides)(overrides.SortAscIcon, _styledComponents.StyledSortAscIcon),
          _getOverrides20 = _slicedToArray(_getOverrides19, 2),
          SortAscIcon = _getOverrides20[0],
          sortAscIconProps = _getOverrides20[1];

      var _getOverrides21 = (0, _overrides.getOverrides)(overrides.SortDescIcon, _styledComponents.StyledSortDescIcon),
          _getOverrides22 = _slicedToArray(_getOverrides21, 2),
          SortDescIcon = _getOverrides22[0],
          sortDescIconProps = _getOverrides22[1];

      var _getOverrides23 = (0, _overrides.getOverrides)(overrides.SortNoneIcon, _styledComponents.StyledSortNoneIcon),
      ...
      function renderHeader(col, colIndex, isFocusVisible) {
        ...
        if (!col.sortable) {
          var _getOverrides25 = (0, _overrides.getOverrides)(colOverrides.TableHeadCell, TableHeadCell),
        ...
        var _getOverrides27 = (0, _overrides.getOverrides)(colOverrides.TableHeadCellSortable, TableHeadCellSortable),
      ...
      function renderCell(col, colIndex, row, rowIndex) {
        ...
        var _getOverrides29 = (0, _overrides.getOverrides)(colOverrides.TableBodyCell, TableBodyCell),
