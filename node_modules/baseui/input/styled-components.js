...
var StyledMaskToggleButton = (0, _index.styled)('button', function (_ref) {
  ...
  var pad = (_SIZE$mini$SIZE$compa = {}, _defineProperty(_SIZE$mini$SIZE$compa, _constants.SIZE.mini, $theme.sizing.scale100), _defineProperty(_SIZE$mini$SIZE$compa, _constants.SIZE.compact, $theme.sizing.scale200), _defineProperty(_SIZE$mini$SIZE$compa, _constants.SIZE.default, $theme.sizing.scale300), _defineProperty(_SIZE$mini$SIZE$compa, _constants.SIZE.large, $theme.sizing.scale400), _SIZE$mini$SIZE$compa)[$size];
  return {
    display: 'flex',
    alignItems: 'center',
    borderTopStyle: 'none',
...
var StyledClearIconContainer = (0, _index.styled)('div', function (_ref2) {
  ...
  var _ref2$$alignTop = _ref2.$alignTop,
      ...
      $size = _ref2.$size,
      $theme = _ref2.$theme;
  var pad = (_SIZE$mini$SIZE$compa2 = {}, _defineProperty(_SIZE$mini$SIZE$compa2, _constants.SIZE.mini, 0), _defineProperty(_SIZE$mini$SIZE$compa2, _constants.SIZE.compact, $theme.sizing.scale0), _defineProperty(_SIZE$mini$SIZE$compa2, _constants.SIZE.default, $theme.sizing.scale100), _defineProperty(_SIZE$mini$SIZE$compa2, _constants.SIZE.large, $theme.sizing.scale200), _SIZE$mini$SIZE$compa2)[$size];
  return {
    display: 'flex',
...
function getRootPadding(adjoined, size, sizing, direction, hasIconTrailing) {
  ...
  return (_SIZE$mini$SIZE$compa4 = {}, _defineProperty(_SIZE$mini$SIZE$compa4, _constants.SIZE.mini, {
    paddingLeft: ifLeftPad ? sizing.scale200 : '0px',
    paddingRight: ifRightPad ? sizing.scale200 : '0px'
  }), _defineProperty(_SIZE$mini$SIZE$compa4, _constants.SIZE.compact, {
    paddingLeft: ifLeftPad ? sizing.scale400 : '0px',
    paddingRight: ifRightPad ? sizing.scale400 : '0px'
  }), _defineProperty(_SIZE$mini$SIZE$compa4, _constants.SIZE.default, {
    paddingLeft: ifLeftPad ? sizing.scale550 : '0px',
    paddingRight: ifRightPad ? sizing.scale550 : '0px'
  }), _defineProperty(_SIZE$mini$SIZE$compa4, _constants.SIZE.large, {
...
function getFont(size, typography) {
  ...
  return (_SIZE$mini$SIZE$compa5 = {}, _defineProperty(_SIZE$mini$SIZE$compa5, _constants.SIZE.mini, typography.font100), _defineProperty(_SIZE$mini$SIZE$compa5, _constants.SIZE.compact, typography.font200), _defineProperty(_SIZE$mini$SIZE$compa5, _constants.SIZE.default, typography.font300), _defineProperty(_SIZE$mini$SIZE$compa5, _constants.SIZE.large, typography.font400), _SIZE$mini$SIZE$compa5)[size];
}
...
function getInputEnhancerPadding($size, sizing) {
  var _SIZE$mini$SIZE$compa6;

  return (_SIZE$mini$SIZE$compa6 = {}, _defineProperty(_SIZE$mini$SIZE$compa6, _constants.SIZE.mini, {
    paddingRight: sizing.scale100,
    paddingLeft: sizing.scale100
  }), _defineProperty(_SIZE$mini$SIZE$compa6, _constants.SIZE.compact, {
    paddingRight: sizing.scale200,
    paddingLeft: sizing.scale200
  }), _defineProperty(_SIZE$mini$SIZE$compa6, _constants.SIZE.default, {
    paddingRight: sizing.scale300,
    paddingLeft: sizing.scale300
  }), _defineProperty(_SIZE$mini$SIZE$compa6, _constants.SIZE.large, {
    paddingRight: sizing.scale400,
    paddingLeft: sizing.scale400
  }), _SIZE$mini$SIZE$compa6)[$size];
}
