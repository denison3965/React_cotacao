...
var StyledLink = (0, _index.withWrapper)(_styledComponents.Link, function (Styled) {
  return function StyledLink(props) {
    return React.createElement(LinkFocus, null, function (focusProps) {
      return React.createElement(Styled, _extends({
        ...
        onFocus: (0, _focusVisible.forkFocus)(props, focusProps.handleFocus),
        onBlur: (0, _focusVisible.forkBlur)(props, focusProps.handleBlur)
      }, props));
    });
  };
});
