...
var BaseButton = (0, _index.styled)('button', function (_ref) {
  ...
  return _objectSpread({
    ...
    outline: $isFocusVisible && $shape !== _constants.SHAPE.round && $shape !== _constants.SHAPE.pill ? "3px solid ".concat($theme.colors.accent) : 'none',
    outlineOffset: '-3px',
    boxShadow: $isFocusVisible && ($shape === _constants.SHAPE.round || $shape === _constants.SHAPE.pill) ? "0 0 0 3px ".concat($theme.colors.accent) : 'none',
    textDecoration: 'none',
