...
export var StyledMaskToggleButton = styled('button', function (_ref) {
  ...
  var pad = (_SIZE$mini$SIZE$compa = {}, _defineProperty(_SIZE$mini$SIZE$compa, SIZE.mini, $theme.sizing.scale100), _defineProperty(_SIZE$mini$SIZE$compa, SIZE.compact, $theme.sizing.scale200), _defineProperty(_SIZE$mini$SIZE$compa, SIZE.default, $theme.sizing.scale300), _defineProperty(_SIZE$mini$SIZE$compa, SIZE.large, $theme.sizing.scale400), _SIZE$mini$SIZE$compa)[$size];
  return {
    display: 'flex',
    alignItems: 'center',
    borderTopStyle: 'none',
...
export var StyledClearIconContainer = styled('div', function (_ref2) {
  ...
  var _ref2$$alignTop = _ref2.$alignTop,
      ...
      $size = _ref2.$size,
      $theme = _ref2.$theme;
  var pad = (_SIZE$mini$SIZE$compa2 = {}, _defineProperty(_SIZE$mini$SIZE$compa2, SIZE.mini, 0), _defineProperty(_SIZE$mini$SIZE$compa2, SIZE.compact, $theme.sizing.scale0), _defineProperty(_SIZE$mini$SIZE$compa2, SIZE.default, $theme.sizing.scale100), _defineProperty(_SIZE$mini$SIZE$compa2, SIZE.large, $theme.sizing.scale200), _SIZE$mini$SIZE$compa2)[$size];
  return {
    display: 'flex',
...
function getFont(size, typography) {
  ...
  return (_SIZE$mini$SIZE$compa5 = {}, _defineProperty(_SIZE$mini$SIZE$compa5, SIZE.mini, typography.font100), _defineProperty(_SIZE$mini$SIZE$compa5, SIZE.compact, typography.font200), _defineProperty(_SIZE$mini$SIZE$compa5, SIZE.default, typography.font300), _defineProperty(_SIZE$mini$SIZE$compa5, SIZE.large, typography.font400), _SIZE$mini$SIZE$compa5)[size];
}
...
function getInputEnhancerPadding($size, sizing) {
  ...
  return (_SIZE$mini$SIZE$compa6 = {}, _defineProperty(_SIZE$mini$SIZE$compa6, SIZE.mini, {
    paddingRight: sizing.scale100,
    paddingLeft: sizing.scale100
  }), _defineProperty(_SIZE$mini$SIZE$compa6, SIZE.compact, {
    paddingRight: sizing.scale200,
    paddingLeft: sizing.scale200
  }), _defineProperty(_SIZE$mini$SIZE$compa6, SIZE.default, {
    paddingRight: sizing.scale300,
    paddingLeft: sizing.scale300
  }), _defineProperty(_SIZE$mini$SIZE$compa6, SIZE.large, {
    paddingRight: sizing.scale400,
    paddingLeft: sizing.scale400
